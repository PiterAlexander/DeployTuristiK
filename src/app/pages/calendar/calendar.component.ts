...
import { GetAllOrdersRequest, GetAllPackagesRequest, OpenModalCreatePackage } from '@/store/ui/actions';
...
export class CalendarComponent implements OnInit {
    ...
    @Output() packagesInformation: EventEmitter<string> = new EventEmitter<string>();
          ...
          next: (data) => {
            ...
            data.forEach((p) => {
              var modeloEvento = {
                ...
                "hotel": p.hotel,
                "start": formatDate(p.departureDate, 'yyyy-MM-dd', 'en-US').toString(),
                "end": formatDate(p.arrivalDate, 'yyyy-MM-dd', 'en-US').toString(),
            ...
            this.calendarOptions = { ...this.calendarOptions, ...{ events: packages } };
    ...
    onEditClick() {
        var pack = this.allPackages.find(p=>p.packageId==this.clickedEvent.id)
